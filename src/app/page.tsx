...
export default function HomePage() {
  ...
  const processedPlaylists = useMemo(() => {
    ...
    // 2. Ordenamiento por fecha de creación/lanzamiento
    result.sort((a, b) => {
  ...
  return (
    <div className="space-y-10">
      ...
      {/* Barra de Búsqueda y Selector de Orden por Fecha */}
      {playlists.length > 0 && (
        <section className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="relative w-full sm:max-w-md">
            ...
            <input
              type="text"
              placeholder="Buscar por título, curador (@usuario), artista..."
              value={searchQuery}
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            ...
            >
              ...
              <span>Fecha: {sortOrder === 'desc' ? 'Más recientes primero' : 'Más antiguas primero'}</span>
